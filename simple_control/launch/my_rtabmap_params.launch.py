...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('Rtabmap_DetectionRate',    default_value='1.0',   description=''),
        DeclareLaunchArgument('RGBD_MaxLoopClosureDistance',    default_value='0.0',   description=''),
        DeclareLaunchArgument('rgbd_proximitymaxgraphdepth',    default_value='50',   description=''),
